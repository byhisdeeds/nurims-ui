...
import {
  ...
  NURIMS_TITLE,
  NURIMS_WITHDRAWN,
  REACTOR_IRRADIATION_AUTHORIZATION_TOPIC, REACTOR_SAMPLE_IRRADIATION_AUTHORIZATION_RECORD_TYPE,
...
class AddEditReactorSampleIrradiationAuthorization extends BaseRecordManager {
  ...
  constructor(props) {
    ...
    this.recordType = REACTOR_SAMPLE_IRRADIATION_AUTHORIZATION_RECORD_TYPE;
