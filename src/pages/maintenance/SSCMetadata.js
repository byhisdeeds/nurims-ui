    ...
    return (
      ...
      >
        <Card variant={"outlined"} style={{marginBottom: 8}} sx={{m: 0, pl: 0, pb: 0, width: '100%'}}>
          <CardHeader title={"General Details"} titleTypographyProps={{fontSize: "1.5em"}}/>
          <CardContent>
        ...
        <Card variant="outlined" style={{marginBottom: 8}} sx={{m: 0, pl: 0, pb: 0, width: '100%'}}>
          <CardHeader title={"Reactor Safety"} titleTypographyProps={{fontSize: "1.5em"}}/>
          <CardContent>
            <Grid container spacing={2}>
              <Grid item xs={12} sm={6}>
                <SelectFormControlWithTooltip
        ...
        <Card variant="outlined" style={{marginBottom: 8}} sx={{m: 0, pl: 0, pb: 0, width: '100%'}}>
          <CardHeader title={"Operations"} titleTypographyProps={{fontSize: "1.5em"}}/>
          <CardContent>
            <Grid container spacing={2}>
              <Grid item xs={12} sm={6}>
                <HtmlTooltip
        ...
        <Card variant="outlined" style={{marginBottom: 8}} sx={{m: 0, pl: 0, pb: 0, width: '100%'}}>
          <CardHeader title={"Surveillance"} titleTypographyProps={{fontSize: "1.5em"}}/>
          <CardContent>
            <Grid container spacing={2}>
              <Grid item xs={12} sm={12}>
                <EditableTable
