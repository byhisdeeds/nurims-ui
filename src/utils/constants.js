module.exports = Object.freeze({
  ...
  SETTINGS: 'settings',
  ADD_EDIT_PERSONNEL: 'hr.add.edit.personnel',
  VIEW_PERSONNEL_RECORDS: 'hr.view.person.records',
  UPDATE_MONITORING_STATUS: 'hr.update.personnel.monitoring.status',
  ADD_DOSIMETRY_MEASUREMENT: 'rp.add.dosimetry.measurement',
  REGISTER_CONTROLLED_MATERIAL_MANUFACTURER: 'cm.register.update.material.manufacturer',
  REGISTER_CONTROLLED_MATERIAL_STORAGE_LOCATION: 'cm.register.update.material.storage.location',
  REGISTER_CONTROLLED_MATERIAL: 'cm.register.update.material',
  VIEW_CONTROLLED_MATERIALS_LIST: 'cm.view.controlled.materials.list',
  ...
  CMD_GET_STORAGE_RECORDS: "get_storage_records",
